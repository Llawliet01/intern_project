    ...
    <div className="bg-[#0a0c16] text-white min-h-screen font-sans selection:bg-[#C4E2F5] selection:text-[#2C5EAD] overflow-x-clip">
      ...
      <section className="relative bg-gradient-to-b from-[#edf4fc] via-[#e6effb] to-[#d6e5fb] py-24 overflow-hidden text-slate-950 border-b border-slate-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {/* Pricing Grid */}
          <div className="grid md:grid-cols-2 gap-8 max-w-3xl mx-auto mb-16 items-stretch">
            {/* Free Plan */}
            <div className="p-8 rounded-3xl bg-white border border-slate-200 shadow-sm flex flex-col justify-between hover:shadow-md transition-shadow relative overflow-hidden group min-h-[480px]">
              {/* Isometric Drawing for Database (Blue theme) - Background Watermark */}
              <svg viewBox="0 0 120 120" className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-[340px] h-[340px] text-blue-500 opacity-[0.14] pointer-events-none z-0">
                <g transform="translate(10, 10)">
                  <path d="M 50,15 L 85,32.5 L 50,50 L 15,32.5 Z" fill="rgba(44,94,173,0.06)" stroke="currentColor" strokeWidth="1.5" />
                  <path d="M 15,32.5 L 15,47.5 L 50,65 L 50,50 Z" fill="rgba(44,94,173,0.12)" stroke="currentColor" strokeWidth="1.5" />
                  <path d="M 50,50 L 50,65 L 85,47.5 L 85,32.5 Z" fill="rgba(44,94,173,0.08)" stroke="currentColor" strokeWidth="1.5" />
                  
                  <path d="M 15,52.5 L 15,67.5 L 50,85 L 50,70 Z" fill="rgba(44,94,173,0.12)" stroke="currentColor" strokeWidth="1.5" />
                  <path d="M 50,70 L 50,85 L 85,67.5 L 85,52.5 Z" fill="rgba(44,94,173,0.08)" stroke="currentColor" strokeWidth="1.5" />

                  <path d="M 15,72.5 L 15,87.5 L 50,105 L 50,90 Z" fill="rgba(44,94,173,0.15)" stroke="currentColor" strokeWidth="1.5" />
                  <path d="M 50,90 L 50,105 L 85,87.5 L 85,72.5 Z" fill="rgba(44,94,173,0.1)" stroke="currentColor" strokeWidth="1.5" />
            ...
            {/* Enterprise Tier */}
            <div className="p-8 rounded-3xl bg-[#05070f] border-2 border-emerald-500 text-white shadow-[0_0_35px_rgba(16,185,129,0.15)] flex flex-col justify-between relative overflow-hidden group min-h-[480px]">
              <div className="absolute top-6 right-6 bg-[#10b981]/15 text-[#10b981] border border-[#10b981]/30 font-mono font-bold text-[9px] uppercase tracking-wider px-3 py-1 rounded-full z-20">
                Most Popular
              </div>

              {/* Isometric Drawing for Server (Green theme) - Background Watermark */}
              <svg viewBox="0 0 120 120" className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-[350px] h-[350px] text-emerald-500 opacity-[0.16] pointer-events-none z-0">
                <g transform="translate(10, 10)">
                  <path d="M 50,15 L 85,32.5 L 50,50 L 15,32.5 Z" fill="rgba(16,185,129,0.1)" stroke="currentColor" strokeWidth="1.5" />
                  <path d="M 15,32.5 L 15,82.5 L 50,100 L 50,50 Z" fill="rgba(16,185,129,0.15)" stroke="currentColor" strokeWidth="1.5" />
                  <path d="M 50,50 L 50,100 L 85,82.5 L 85,32.5 Z" fill="rgba(16,185,129,0.05)" stroke="currentColor" strokeWidth="1.5" />
                  
                  <path d="M 22,43 L 45,54.5 L 45,58.5 L 22,47 Z" fill="currentColor" className="animate-pulse" />
                  <path d="M 22,55 L 45,66.5 L 45,70.5 L 22,59 Z" fill="#34d399" />
                  <path d="M 22,67 L 45,78.5 L 45,82.5 L 22,71 Z" fill="currentColor" className="animate-pulse" />
                  
                  <circle cx="50" cy="50" r="25" fill="none" stroke="currentColor" strokeWidth="1" strokeDasharray="3 3" className="animate-spin" style={{ transformOrigin: '50px 50px', animationDuration: '8s' }} />
                </g>
              </svg>
